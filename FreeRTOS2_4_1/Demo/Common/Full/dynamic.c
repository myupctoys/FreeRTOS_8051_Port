...
static portCHAR cSuspendedQueueSendError = ( portCHAR ) pdFALSE;
static portCHAR cSuspendedQueueReceiveError = ( portCHAR ) pdFALSE;
...
void vStartDynamicPriorityTasks( void )
{
	...
	sTaskCreate( vContinuousIncrementTask, "CONT_INC", priSTACK_SIZE, ( void * ) &ulCounter, tskIDLE_PRIORITY, &xContinousIncrementHandle );
	sTaskCreate( vLimitedIncrementTask, "LIM_INC", priSTACK_SIZE, ( void * ) &ulCounter, tskIDLE_PRIORITY + 1, &xLimitedIncrementHandle );
	sTaskCreate( vCounterControlTask, "C_CTRL", priSTACK_SIZE, NULL, tskIDLE_PRIORITY, NULL );
	sTaskCreate( vQueueSendWhenSuspendedTask, "SUSP_SEND", priSTACK_SIZE, NULL, tskIDLE_PRIORITY, NULL );
	sTaskCreate( vQueueReceiveWhenSuspendedTask, "SUSP_RECV", priSTACK_SIZE, NULL, tskIDLE_PRIORITY, NULL );
}
/*-----------------------------------------------------------*/
...
{
unsigned portLONG *pulCounter;
unsigned portCHAR ucOurPriority;
	...
	ucOurPriority = ucTaskPriorityGet( NULL );
