...
void vStartIntegerMathTasks( unsigned portCHAR ucPriority )
{
	sTaskCreate( vCompeteingIntMathTask1, "IntMath1", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 0 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask2, "IntMath2", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 1 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask3, "IntMath3", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 2 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask4, "IntMath4", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 3 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask1, "IntMath5", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 4 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask2, "IntMath6", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 5 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask3, "IntMath7", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 6 ] ), ucPriority, NULL );
	sTaskCreate( vCompeteingIntMathTask4, "IntMath8", intgSTACK_SIZE, ( void * ) &( usTaskCheck[ 7 ] ), ucPriority, NULL );
}
/*-----------------------------------------------------------*/
...
const portCHAR * const pcTaskFailMsg = "Integer math task 3 failed.\r\n";
	...
	plArray = ( portLONG * ) pvPortMalloc( ( unsigned portSHORT ) 250 * sizeof( portLONG ) );
...
portSHORT sAreIntegerMathsTaskStillRunning( void )
{
